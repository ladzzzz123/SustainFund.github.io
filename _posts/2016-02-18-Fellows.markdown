...
Can we improve deal flow -- to utilize the competitive efforts of many contenders to winnow out the winners and losers in the idea space.  Can we use smart contracts in order to better reward effort of people working on different nanoenterprises? 
